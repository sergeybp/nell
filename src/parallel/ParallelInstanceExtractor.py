...
def extract_instances(db, iteration, useMorph, nowCategory):
    logging.info("Begin instances extracting for category: " + nowCategory['category_name'])
...
def evaluate_instances(db, tT, tMode, tK, tN, iteration, ins_ngrams, MODE, dict_length, nowCategory):
    logging.info('Begin instances evaluating for category: '+ nowCategory['category_name'])
